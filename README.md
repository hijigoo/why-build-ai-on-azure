...
| 형태 | 링크 | 조작·특징 |
|---|---|---|
| **원페이지** | **[열기 ↗](https://hijigoo.github.io/why-build-ai-on-azure/why-build-ai-on-azure-onepage.html)** | 세로 스크롤 · 좌측 목차 · 장표별 설명 접기 · `J`/`K` 이동 · `N` 설명 전체 · `M` 목차 |
...
- **장표별 설명 접기** — 전체 on/off가 아니라 설명 헤더마다 토글 버튼이 하나씩
